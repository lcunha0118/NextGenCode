...
pol_data_buf_final=pol_data.copy()
pol_data_buf = pol_data.buffer(0.06)
pol_data_buf_final['geometry']=pol_data_buf
pol_data_buf_final.index=pol_data_buf_final['hru_id']
...
for i in range (0,len(CAMELS_516)):
    ...
    if(int(hru_id) in pol_data_buf_final.index):
        selection=pol_data_buf_final.loc[int(hru_id)]
    else:
