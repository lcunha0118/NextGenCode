        ...
        if not src_array is None:
            ...
            if(Check>50):   
                ...
                if(output_flag==1):
                    ...
                    f.write("%s" %("gw_storage=0.05\n"))
                    f.write("%s" %("alpha_fc=0.33\n"))
                    f.write("%s" %("soil_storage=0.05\n"))
...
# namestr='01350140'
# catchments='/home/west/Projects/CAMELS/PerBasin4//'+namestr+'/spatial/catchment_data.geojson'
# time_to_stream_raster='/home/west/Projects/CAMELS/PerBasin4//'+namestr+'/'+namestr+'dsave1.tif'
# NWM_param_file='/home/west/Projects/CAMELS/PerBasin4//'+namestr+'/parameters/nwm.csv'

# # GW_params_file='../PerBasin2//'+namestr+'/gwbucket-params-fullrouting.csv'
# outputfolder_giuh='../PerBasin4///data_CAMELS/'+namestr +"/"
...
# generate_giuh_per_basin(namestr,catchments, time_to_stream_raster,NWM_param_file, outputfolder_giuh,
#                         nodata_value = nodata_value,buffer_distance = buffer_distance,output_flag = output_flag)    
